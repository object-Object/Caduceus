...
@Mixin(targets = "at/petrak/hexcasting/api/casting/eval/vm/FrameForEach$Companion$TYPE$1", remap = false)
public abstract class MixinFrameForEachType {
    @ModifyReturnValue(method = "deserializeFromNBT", at = @At("RETURN"))
    private FrameForEach caduceus$deserializeMark(
        FrameForEach newFrame,
